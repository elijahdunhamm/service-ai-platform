...
import { idreamofcleaningPreset } from "./idreamofcleaning";
...
export const PRESETS: Record<string, IndustryConfig> = {
  ...
  idreamofcleaning: idreamofcleaningPreset,
};

export const DEFAULT_PRESET_ID = "cleaning";
export const defaultPreset: IndustryConfig = cleaningPreset;

export { cleaningPreset, hvacPreset, detailingPreset, idreamofcleaningPreset };
